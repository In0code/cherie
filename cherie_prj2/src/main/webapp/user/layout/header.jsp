						...
						<fieldset>
							<input id="searchKeyword" name="searchKeyword" fw-label="검색어"
								...
								<button class="search_button" id="searchIcon">
									<img src="http://localhost/prj_web_shopping/common/images/icon/search.png" width="30px"/>
								</button>
						</fieldset>
					</div>
			...
			<div class="inner" style="font-family:'MADE Voyager PERSONAL_USE'">
				...
				<div class="topArea__statelogon">
					<ul class="xans-element- xans-layout xans-layout-statelogoff ">
						<li class="headSearchBtn">
							...
							<a href="javascript:void(0)" onclick="searchLayerToggle()">
								<img src="http://localhost/prj_web_shopping/common/images/icon/search.png" width="20px" class="icon-magnifier headSearchBtn_magnifier"/>
								<img src="http://localhost/prj_web_shopping/common/images/icon/remove.png" width="20px" class="icon-close headSearchBtn_close"/>
				...
				<h1 class="xans-element- xans-layout xans-layout-logotop topArea__logo " >
					<a href="http://localhost/prj_web_shopping/user/main.jsp">
						<img src="http://localhost/prj_web_shopping/common/images/logo.png" alt="Cherie">
					</a>
				</h1>
			</div>
		</header>
