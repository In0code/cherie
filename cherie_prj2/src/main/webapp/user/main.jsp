				...
				<div class="inside RW">
					...
					<div class="bg_index">
						...
						<ul style="font-family:Playfair Display Medium">
							<li><a href="http://localhost/prj_web_shopping/user/about.jsp">About</a></li>
							<li><a href="http://localhost/prj_web_shopping/user/shop.jsp">Shop</a></li>
						</ul>
					</div>
				</div>
					...
					<ul class="proRight">
						...
						<li class="proBox">
							<a href="product_detail.jsp?gcode=PF0007">
								<img src="http://localhost/prj_web_shopping/common/images/perfume1-2.png" alt="">
							</a>
						</li>
						<li>
